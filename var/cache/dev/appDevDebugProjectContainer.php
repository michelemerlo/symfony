...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d' => 'get164a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0dService',
            '2_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d' => 'get264a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0dService',
            'AppBundle\\Controller\\DefaultController' => 'getAppBundle_Controller_DefaultControllerService',
            'AppBundle\\Service\\FileUploader' => 'getAppBundle_Service_FileUploaderService',
            ...
            'service_locator.203a951556bf12a119ba9229796ec151' => 'getServiceLocator_203a951556bf12a119ba9229796ec151Service',
            'service_locator.5b9aaa3e534b58975f21f9924ec0b2e6' => 'getServiceLocator_5b9aaa3e534b58975f21f9924ec0b2e6Service',
            'service_locator.e64d23c3bf770e2cf44b71643280668d' => 'getServiceLocator_E64d23c3bf770e2cf44b71643280668dService',
            'service_locator.f31de25388d884608b0626da2a051f7c' => 'getServiceLocator_F31de25388d884608b0626da2a051f7cService',
        ...
        $this->privates = array(
            '1_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d' => true,
            '2_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d' => true,
            ...
            'service_locator.203a951556bf12a119ba9229796ec151' => true,
            'service_locator.5b9aaa3e534b58975f21f9924ec0b2e6' => true,
            'service_locator.e64d23c3bf770e2cf44b71643280668d' => true,
            'service_locator.f31de25388d884608b0626da2a051f7c' => true,
    ...
    protected function getAssets_PackagesService()
    {
        ...
        return $this->services['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', $b, $a), array('uploaded_files' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'http://10.12.48.150/test/web/images/'), $b, $a)));
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d']) ? $this->services['1_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d'] : $this->get164a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0dService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d']) ? $this->services['2_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d'] : $this->get264a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0dService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'php', 'user' => 'mmerlo', 'password' => '523jh829', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ef8209ed5c20a70014bac66a29553a75fe903b6d0423d9d2eec82049770dcca0');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/homepage');
        ...
        $l->setOptions(array('login_path' => '/', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $m->setOptions(array('login_path' => '/', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $n = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $j, '/', false);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($i, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => ${($_ = isset($this->services['security.user.provider.concrete.in_memory']) ? $this->services['security.user.provider.concrete.in_memory'] : $this->getSecurity_User_Provider_Concrete_InMemoryService()) && false ?: '_'}), 'main', $a, $c, $d), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'main', $l, $m, array('check_path' => '/', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $g, 'main', $n, $a), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '59ef302b4e7a84.25937287', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $i, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $j, 'main', $n, NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.in_memory', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'http_basic', 3 => 'anonymous')));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler(($this->targetDirs[2].'/sessions/dev/dev'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $instance->setHost('faismtp.bl.ch:25');
        $instance->setPort(25);
    ...
    /**
     * Gets the private '1_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get164a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0dService()
    {
        return $this->services['1_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get264a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0dService()
    {
        return $this->services['2_64a9e33f6c4982a048036f07535764da6fd24c3df4404f10a013f2937930fc0d'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }

    /**
     * Gets the private 'AppBundle\Service\FileUploader' shared autowired service.
     *
     * @return \AppBundle\Service\FileUploader
     */
    protected function getAppBundle_Service_FileUploaderService()
    {
        return $this->services['AppBundle\Service\FileUploader'] = new \AppBundle\Service\FileUploader(($this->targetDirs[3].'/web/images'));
    }
    ...
    {
        return $this->services['argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Controller\\DefaultController:editAction' => function () {
            return ${($_ = isset($this->services['service_locator.5b9aaa3e534b58975f21f9924ec0b2e6']) ? $this->services['service_locator.5b9aaa3e534b58975f21f9924ec0b2e6'] : $this->getServiceLocator_5b9aaa3e534b58975f21f9924ec0b2e6Service()) && false ?: '_'};
        }, 'AppBundle\\Controller\\DefaultController:indexAction' => function () {
            return ${($_ = isset($this->services['service_locator.203a951556bf12a119ba9229796ec151']) ? $this->services['service_locator.203a951556bf12a119ba9229796ec151'] : $this->getServiceLocator_203a951556bf12a119ba9229796ec151Service()) && false ?: '_'};
        }, 'AppBundle\\Controller\\DefaultController:mailredirectAction' => function () {
            return ${($_ = isset($this->services['service_locator.f31de25388d884608b0626da2a051f7c']) ? $this->services['service_locator.f31de25388d884608b0626da2a051f7c'] : $this->getServiceLocator_F31de25388d884608b0626da2a051f7cService()) && false ?: '_'};
        }, 'AppBundle\\Controller\\DefaultController:newAction' => function () {
            return ${($_ = isset($this->services['service_locator.5b9aaa3e534b58975f21f9924ec0b2e6']) ? $this->services['service_locator.5b9aaa3e534b58975f21f9924ec0b2e6'] : $this->getServiceLocator_5b9aaa3e534b58975f21f9924ec0b2e6Service()) && false ?: '_'};
        }, 'AppBundle\\Controller\\DefaultController::editAction' => function () {
            return ${($_ = isset($this->services['service_locator.5b9aaa3e534b58975f21f9924ec0b2e6']) ? $this->services['service_locator.5b9aaa3e534b58975f21f9924ec0b2e6'] : $this->getServiceLocator_5b9aaa3e534b58975f21f9924ec0b2e6Service()) && false ?: '_'};
        }, 'AppBundle\\Controller\\DefaultController::indexAction' => function () {
            return ${($_ = isset($this->services['service_locator.203a951556bf12a119ba9229796ec151']) ? $this->services['service_locator.203a951556bf12a119ba9229796ec151'] : $this->getServiceLocator_203a951556bf12a119ba9229796ec151Service()) && false ?: '_'};
        }, 'AppBundle\\Controller\\DefaultController::mailredirectAction' => function () {
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('sgloDX3kgN', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m7TFKGOqky', 0, 'LXTZ1L2qmyLDePS5EmAUI2', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3iGqgiaFva', 0, 'LXTZ1L2qmyLDePS5EmAUI2', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uNZuea50XD', 0, 'LXTZ1L2qmyLDePS5EmAUI2', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59ef302b4e7a84.25937287');
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('merlo', 'mandarine', array(0 => 'ROLE_USER')));
    ...
    /**
     * Gets the private 'service_locator.203a951556bf12a119ba9229796ec151' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function getServiceLocator_203a951556bf12a119ba9229796ec151Service()
    {
        return $this->services['service_locator.203a951556bf12a119ba9229796ec151'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('authUtils' => function () {
    ...
    /**
     * Gets the private 'service_locator.5b9aaa3e534b58975f21f9924ec0b2e6' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function getServiceLocator_5b9aaa3e534b58975f21f9924ec0b2e6Service()
    {
        return $this->services['service_locator.5b9aaa3e534b58975f21f9924ec0b2e6'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('fileUploader' => function () {
            $f = function (\AppBundle\Service\FileUploader $v = null) { return $v; }; return $f(${($_ = isset($this->services['AppBundle\Service\FileUploader']) ? $this->services['AppBundle\Service\FileUploader'] : $this->getAppBundle_Service_FileUploaderService()) && false ?: '_'});
        }));
    }
    ...
    /**
     * Gets the private 'service_locator.f31de25388d884608b0626da2a051f7c' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function getServiceLocator_F31de25388d884608b0626da2a051f7cService()
    {
        return $this->services['service_locator.f31de25388d884608b0626da2a051f7c'] = new \Symfony\Component\DependencyInjection\ServiceLocator(array('mailer' => function () {
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'file_directory': $value = ($this->targetDirs[3].'/web/images'); break;
            case 'session.save_path': $value = ($this->targetDirs[2].'/sessions/dev/dev'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'php',
            'database_user' => 'mmerlo',
            'database_password' => '523jh829',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'faismtp.bl.ch:25',
            'mailer_user' => NULL,
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'faismtp.bl.ch:25',
